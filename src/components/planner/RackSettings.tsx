...
import { BUDGET_TIERS } from '@/lib/calculator/config';
import type { BudgetTier } from '@/lib/calculator/types';
import { NumberInput } from './NumberInput';
import { cn } from '@/lib/utils';

export function RackSettings() {
  const { rackType, rack, setRack, budget, setBudget } = usePlannerStore();
